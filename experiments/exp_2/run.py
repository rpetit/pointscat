...
std_noise = 0.1
noise = np.random.normal(0, std_noise, (30,))
alpha = 0.25 * np.sqrt(2 * np.log(30)) * std_noise
...
for i in range(len(sep_dist_tab)):
    ...
    estimated_measure = solve_blasso(frequencies, noisy_obs, reg_param_lin, num_iter, box_size,
